...
[Icons]
Name: "{commondesktop}\SageMath Notebook"; WorkingDir: "{app}"; Filename: "{sys}\WindowsPowerShell\v1.0\powershell.exe"; Parameters: "-WindowStyle Hidden -ExecutionPolicy Unrestricted -File Start-SageMath.ps1 -OpenBrowser -Notebook"; IconFilename: "{app}\sagemath.ico"; Components: SageMath
